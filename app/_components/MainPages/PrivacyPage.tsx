...
export default async function PrivacyPage({ data }: PrivacyPageProps) {
  ...
  return (
    <>
      <section className="bg-white text-center pt-20">
        {/* <Breadcrumb title={data.Title} /> */}

        <h1 className="text-[32px] md:text-[62px] font-semibold text-primary uppercase">
          {data?.Title}
        </h1>
      </section>

      <section>
        <div className="my-8 md:my-[60px] max-w-[1432px] mx-auto  px-4 text-primary">
