...
export default function GalleryPopup({ Images }: { Images: singleImage[] }) {
    const [thumbsSwiper, setThumbsSwiper] = useState<SwiperType | null>(null);
    const [mainNav, setMainNav] = useState<{ prevEl: HTMLElement | null; nextEl: HTMLElement | null }>({ prevEl: null, nextEl: null });
    const [thumbNav, setThumbNav] = useState<{ prevEl: HTMLElement | null; nextEl: HTMLElement | null }>({ prevEl: null, nextEl: null });
    ...
    return (
        <div className="bg-[#222222] fixed inset-0 w-full z-40 py-[50px] space-y-[60px] h-full">
            {/* Main Swiper */}
