        ...
        <div className='relative lg:w-[50%] w-full aspect-[1000/835] group overflow-hidden'>
            ...
            <div className=' relative flex flex-col justify-between z-10 h-full'>
                ...
                <div
                    ...
                    <h2 className=' text-white font-medium xl:text-[52px] md:text-4xl text-[28px]'>{data.Title}</h2>
                    <p className=' text-white text-opacity-80 xl:text-4xl md:text-2xl text-base'>{data.ShortDescription}</p>
