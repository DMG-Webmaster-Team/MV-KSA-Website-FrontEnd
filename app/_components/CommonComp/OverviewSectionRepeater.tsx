...
export default function OverviewSectionRepeater({
  OverviewSectionData,
  Repeater,
  vision,
}: {
  OverviewSectionData: OverviewSectionProps;
  Repeater: Repeater[];
  vision?: boolean;
}) {
  return (
    <div
      id="Overview"
      className="flex max-w-[1448px] px-4 mx-auto items-start md:py-20 py-10  xl:gap-[100px] md:gap-[50px] gap-10 lg:flex-row flex-col"
    >
