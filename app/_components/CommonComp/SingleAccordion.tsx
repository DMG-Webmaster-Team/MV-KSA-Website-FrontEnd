...
export default function SingleAccordion({
  ...
  return (
    <div className=" border-b border-gray2">
      <h3
        className=" md:py-6 py-4 justify-between text-primary md:text-2xl text-base font-medium flex gap-10 cursor-pointer"
      ...
      >
        <p
          className={`${
            Big ? "md:text-xl text-sm" : "text-sm"
          } text-primary opacity-50 md:pt-4 pt-4 md:pb-6 pb-4`}
        >
          {item.Description}
        </p>
      </motion.div>
