...
export default function MainHeader() {
    ...
    const StableHeader = Pathname == "/calendly" || Pathname == "/en/calendly" || Pathname == "/en/faqs" || Pathname == "/faqs";
        ...
        <>
            <div className={`${openMenu ? " bg-darkblue" : ""} ${StableHeader ? "" : "absolute top-0"} transition-all duration-500  w-full z-40 py-2.5 border-b-[2px] border-white border-opacity-20`}>
                <div className="max-w-[1448px] px-4 mx-auto flex justify-between items-center">
                    <Link className=" relative rtl:2xl:w-[268px] rtl:xl:w-[220px] rtl:sm:w-[200px] rtl:w-[153px] ltr:2xl:w-[240px] ltr:w-[200px] aspect-[401/105]" href={`${locale == "en" ? "/en" : ""}/`}>
                        {StableHeader ?
                            <Image
                                src={'/logoblack.webp'}
                                alt="Logo MV KSA"
